...
local function do_fair(p, orientation)
    ...
    elseif orientation == "widefair" then
        -- Layout with fixed number of vertical columns (read from nmaster).
        -- Windows fill the workarea until there is nmaster columns/clients,
        -- then windows are stacked in the slave columns, with at most ncol
        -- clients per column if possible.
...
function termfair.wide.arrange(p)
    return do_fair(p, "widefair")
end
